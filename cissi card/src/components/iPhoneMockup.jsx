    ...
    <div className="iphone-wrapper">
      ...
      <style jsx>{`
        ...
        .iphone-outer {
          ...
          width: 300px;
          height: 600px;
          background: #A3C1DA; /* Blue-200 equivalent */
          border: 4px solid #8EACC5; /* Blue-300 equivalent */
          border-radius: 45px;
          position: relative;
          padding: 12px;
          box-shadow: 
        ...
        .iphone-inner {
          width: 100%;
          height: 100%;
          background: #E6EEF5; /* AliceBlue base */
          background-image: 
            radial-gradient(at 0% 0%, #D4E1EE 0, transparent 50%), 
            radial-gradient(at 100% 100%, #BCCFDA 0, transparent 50%);
          border-radius: 35px;
          overflow: hidden;
          position: relative;
