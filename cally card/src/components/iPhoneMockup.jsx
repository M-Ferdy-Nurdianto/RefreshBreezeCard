    ...
    <div className="iphone-wrapper">
      ...
      <style jsx>{`
        ...
        .iphone-outer {
          ...
          width: 300px;
          height: 600px;
          background: #8ec7c0; /* Frostbite */
          border: 4px solid #7ab3ac; /* Darker Frostbite */
          border-radius: 45px;
          position: relative;
          padding: 12px;
          box-shadow:
        ...
        .iphone-inner {
          width: 100%;
          height: 100%;
          background: #a7c3e2; /* Blue Frost base */
          background-image:
            radial-gradient(at 0% 0%, #b8d1ed 0, transparent 50%),
            radial-gradient(at 100% 100%, #96b5d7 0, transparent 50%);
          border-radius: 35px;
          overflow: hidden;
          position: relative;
        ...
        .iphone-button {
          position: absolute;
          background: #7ab3ac; /* Darker Frostbite */
          border-radius: 2px;
        }
        .silent {
          left: -6px;
